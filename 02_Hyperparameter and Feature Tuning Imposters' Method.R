...
#hyperparameters for the Imposters' Method. A grid search means to systematically 
#go through all possible combinations and to estimate how well they will perform.
#In order to do this, 
# 1. Define the combinations of features to evaluate
# 2. Define the combinations of values for the hyperparameters "distance", "features",
#    and "imposters",
...
#times, and then take the arithmetic mean.
